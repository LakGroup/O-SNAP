...
function data = load_variables(file_path, vars_to_load, options)
    arguments
        file_path string
        vars_to_load cell
    ...
    try
        [file_has_variables, vars_missing] = has_variables(file_path, vars_to_load, "verbose", options.verbose);
        if file_has_variables
