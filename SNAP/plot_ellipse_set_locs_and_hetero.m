function plot_ellipse_set_locs_and_hetero(file_path, max_radial_loc_density, max_radial_dbscan_cluster_density,options)
arguments
    file_path string
    ...
    if ~exist(plot_file,'file') || options.overwrite
        plot_ellipse_set(data.radial_loc_density,...
            data.locs_norm,...
    ...
    if ~exist(plot_file,'file') || options.overwrite
        ...
        plot_ellipse_set(data.radial_dbscan_cluster_density,...
