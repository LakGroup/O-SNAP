function [feature_compare_data,feature_compare_data_filtered] = compare_group_pair(feature_data,group_1,group_2,options)
    arguments
        feature_data table;
        group_1 string;
        group_2 string;
    ...
    if options.save_path ~= ""
        plot_SNAP_volcano(feature_compare_data,group_1,group_2,...
            "alpha",options.alpha,...
