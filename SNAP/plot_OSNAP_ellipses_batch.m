function plot_OSNAP_ellipses_batch(T,work_dir,groups,reps,options)
arguments
    T table
    work_dir string
    groups cell
...
%% get data
data_info_table = get_valid_OSNAP_samples(work_dir,groups,reps,{'radial_loc_density','radial_dbscan_cluster_density'});
