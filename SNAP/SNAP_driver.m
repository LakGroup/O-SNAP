...
% %%
% analysis_name = 'ANALYSIS_ZG_MCF10A_H2B_Ctrl_Ctrl_H31_C96S';
% reps = {'0_Test1','1_Test2'};
% groups = {'Ctrl','H31_C96S'};
% run_SNAP(root_dir,analysis_name,groups,reps);
% %%
% analysis_name = 'ANALYSIS_ZG_MCF10A_H2B_Ctrl_H31_C96S_NLS_Catalase';
% reps = {'0_Test1','1_Test2'};
% groups = {'H31_C96S','NLS_Catalase'};
% run_SNAP(root_dir,analysis_name,groups,reps);
% %%
% analysis_name = 'ANALYSIS_ZG_MCF10A_H2B_Ctrl_Ctrl_NLS_Catalase';
% reps = {'0_Test1','1_Test2'};
% groups = {'Ctrl','NLS_Catalase'};
% run_SNAP(root_dir,analysis_name,groups,reps);
% %%
