...
groups = {'Ctrl','TSA'};
run_SNAP_v2('E:\',analysis_name,groups,replicates,"run_comparison",1,"run_generate_batches",0,"run_feature_selection",0,"run_PCA",0,"run_classification_batch",0,"split_method","k-fold");
%%
analysis_name = 'ANALYSIS_HK_BJ_TSA_H2B_shuffled';
% replicates = {'20240920','20240930','20241010','20241011','20241018'};
replicates = {'20240930','20241010','20241011','20241018'};
groups = {'Ctrl','TSA'};
run_SNAP_v2(root_dir,analysis_name,groups,replicates,"run_comparison",1,"run_generate_batches",0,"run_feature_selection",0,"run_PCA",0,"run_classification_batch",0,"split_method","k-fold","run_generate_table",0,"save",1);
%%
analysis_name = 'ANALYSIS_TB_HeLa_TSA_H2B';
replicates = {'0'};
groups = {'Control','TSA-1H','TSA-6H','TSA-24H'};
run_SNAP_v2('E:\',analysis_name,groups,replicates,"run_comparison",1,"run_generate_batches",1,"run_feature_selection",1,"run_PCA",1,"run_classification_batch",1);
%%
...
% run_SNAP_v2(root_dir,analysis_name,groups,replicates,"run_generate_table",1,"run_comparison",0,"run_generate_batches",0,"run_feature_selection",0,"run_PCA",0,"run_classification_batch",0,'run_FSEA',0);
% %%  
...
% run_SNAP_v2('E:\',analysis_name,groups,replicates,"run_generate_table",1,"run_comparison",0,"run_generate_batches",0,"run_feature_selection",0,"run_PCA",0,"run_classification_batch",0,'run_FSEA',0);
%%
...
groups = {'Ctrl','LMNAKD'};
run_SNAP_v2(root_dir,analysis_name,groups,replicates,"run_comparison",1,"run_generate_batches",1,"run_feature_selection",1,"run_PCA",1,"run_classification_batch",1);
%%
...
run_SNAP_v2(root_dir,analysis_name,groups,replicates,"run_comparison",1,"run_generate_batches",0,"run_feature_selection",0,"run_PCA",0,"run_classification_batch",0,"run_generate_table",0);
%%
analysis_name = 'ANALYSIS_AM_Heterokaryon_H2B_CtrlhFb_CtrlmESC_HK48h_shuffled';
replicates = {'0','1','2','3'};
groups = {'CtrlhFb','CtrlmESC','HK48h'};
run_SNAP_v2(root_dir,analysis_name,groups,replicates,"run_comparison",0,"run_generate_batches",0,"run_feature_selection",0,"run_PCA",0,"run_classification_batch",0,"run_generate_table",0,"split_method","k-fold","save",1);
%%
