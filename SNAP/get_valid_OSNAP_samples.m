...
%   SNAP_nucleus_file_list = get_valid_OSNAP_samples("D:\Analysis\ExperimentA",...
%                                 {'Control','KO'},...
...
function SNAP_nucleus_file_list = get_valid_OSNAP_samples(work_dir,groups,replicates,vars_to_load)
    ...
    %         SNAP_nucleus_file_list = search_and_find_valid_SNAP_samples(work_dir,groups,replicates,vars_to_load);
    %     end
...
function SNAP_nucleus_file_list = search_and_find_valid_SNAP_samples(work_dir,groups,reps,vars_to_load)
