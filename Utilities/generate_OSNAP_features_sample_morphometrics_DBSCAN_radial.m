% -------------------------------------------------------------------------
% extract_OSNAP_morphometrics_dbscan_radial_features.m
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
function generate_OSNAP_features_sample_morphometrics_DBSCAN_radial(filepath, density_threshold, options)
arguments
    filepath string
...
if ~all(isfield(data,{'interior_cluster_density', ...
        'periphery_cluster_density'})) 
    locs_dbscan_cluster = [data.periphery_dbscan_cluster_center; data.interior_dbscan_cluster_center];
    [interior_cluster_density, periphery_cluster_density] = calculate_OSNAP_periphery_density(normalize_points(locs_dbscan_cluster,data.components,data.boundary),...
...
if options.plot
    plot_OSNAP_DBSCAN_LAD(filepath,"data",data,"periphery_thresh",options.periphery_thresh);
end
end
