...
save_dir = replace(save_dir,"nucleus_data","radial_density_images");
if ~exist(save_dir,'dir')
    mkdir(save_dir)
end
%% Plot radial localization density
...
%% Perform normalization to localizations
